...
hidden if the `glpaper_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `glpaper_DEVELOPER_MODE` to the configure
...
Runs the executable target `glpaper_exe`.
